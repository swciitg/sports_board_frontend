...
const Footer = (props) =>
{
    ...
    return (
        <div id="containerone"  className="flex flex-row gap-64 w-100% h-80 mt-0 pl-0 px-0" style={{position:'relative',zIndex:'1',backgroundColor: color}}>
            <div id="part1" className="flex ml-44 gap-x-20 justify-around">
                <div className="image w-52 h-52"><img id="img" className=" h-52 w-52" src={gymkhanalogo} alt=""/></div>
